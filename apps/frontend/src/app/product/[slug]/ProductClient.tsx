...
import {
  ...
  faIndustry,
  faBox,
  faBuilding, faThumbsUp, faThumbsDown, faBalanceScale
    ...
    <section className="bg-[#FAF3E2]">
          ...
          <div className="pt-2">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-3 mb-5">
                <p className="text-[28px] md:text-[24px] font-bold text-[#5E2B16]">₹370</p>
                ...
                {tab === "reviews" && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-[18px] md:text-[22px] text-[#5e2b16] font-bold">4.3</span>
                ...
                {[
                  ...
                  >
                    <div className="w-[32px] h-[32px] md:w-[36px] md:h-[36px] rounded-full bg-[#EBF1DC] flex items-center justify-center">
                      <FontAwesomeIcon icon={item.icon} className="text-[#819744] text-sm md:text-base" />
                    </div>
      ...
      <div className="bg-[#EBF1DC] py-10 px-4 md:px-12">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12">
          ...
          >
            ...
            <div className="space-y-3 text-[#5E2B16] text-[13px] sm:text-[14px] md:text-[16px]">
              ...
              {[
                ["Skin Type:", "All skin types, including sensitive, dry, oily, and combination skin"],
          ...
          >
            ...
            <div className="space-y-4 text-[#5C6936] text-[13px] sm:text-[14px] md:text-[16px]">
              ...
              {[
                { icon: faClipboardCheck, text: "Always patch test before first use, especially if you have sensitive skin." },
                { icon: faSnowflake, text: "Store in a cool, dry place away from direct sunlight." },
                { icon: faLeaf, text: "Handle with care—natural ingredients may separate slightly, which is normal." },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <FontAwesomeIcon icon={item.icon} className="mt-1 text-[#819744]" />
                  <p>{item.text}</p>
                </motion.div>
              ))}
        ...
        >
          ...
          <div className="flex justify-center items-center gap-4 md:gap-6 mb-6 text-[#819744] font-semibold text-[18px] sm:text-[22px] md:text-[28px]">
            <div className="w-[140px] sm:w-[200px] md:w-[284px] text-center">Before</div>
            <div className="w-[140px] sm:w-[200px] md:w-[284px] text-center">After</div>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-4 relative">
            ...
            >
              <div className="relative w-full h-[160px] sm:h-[220px] md:h-[313px]">
                <Image src="/img/before1.png" alt="before" fill className="object-cover" />
              </div>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 z-10 top-[45%] md:top-auto">
              <div className="w-[60px] h-[35px] sm:w-[80px] sm:h-[45px] md:w-[114px] md:h-[59px]
            ...
            >
              <div className="relative w-full h-[160px] sm:h-[220px] md:h-[313px]">
                <Image src="/img/after1.png" alt="after" fill className="object-cover" />
              </div>
              <div className="h-[40px] md:h-[55px] flex items-center justify-center bg-[#FAF3E2]">
                <p className="text-[12px] md:text-sm text-[#819744] font-bold">
                  Radiant Skin
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-8 max-w-6xl mx-auto">
          ...
          {products.map((item, i) => (
            ...
            >
              ...
              >
                <FontAwesomeIcon icon={faCartShopping} className="text-[#5E2B16] text-sm md:text-base" />
              </motion.div>
              ...
              <div className="absolute bottom-0 left-0 w-full bg-black/50 backdrop-blur-md text-white p-3 md:p-4">
               ...
               <div className="flex items-center justify-between gap-2">
                ...
                {/* STAR */}
                <div className="flex items-center gap-1 bg-[#F5A623] text-white 
      ...
      <div className="bg-[#F5F0E6] py-10 px-4 sm:px-6 md:py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-3 md:space-y-4">
          ...
          {faqs.map((item, i) => (
            ...
            >
              ...
              >
                <span className="font-semibold text-[#5E2B16] 
        ...
        <div className="max-w-4xl mx-auto mt-10 md:mt-16 bg-white rounded-lg md:rounded-xl shadow-sm md:shadow-md p-4 sm:p-5 md:p-6">
          ...
          <h3 className="text-[#819744] font-semibold 
