    ...
    <section className="bg-[#FAF3E2]">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between w-full">
          ...
          {/* RIGHT IMAGE (CIRCLE) */}
          <div className="w-[70px] h-[70px] sm:w-[60px] sm:h-[60px] md:w-[90px] md:h-[90px] 
      ...
      <div className="px-6 md:px-12 py-10 grid grid-cols-2 gap-10 max-md:grid-cols-1">
        ...
        >
            ...
            Say goodbye to dullness and uneven skin, lock in moisture for soft, supple skin,
            and enjoy balanced care that leaves your face feeling clean, energized, and healthy.
        </motion.p>
        ...
        <p className="mb-6 text-[15px]">
            <span className="font-['Roboto_Flex'] font-semibold text-[20px] text-[#3B7509]">Best suited for:</span>{" "}
       ...
       <div className="bg-[#EBF1DC] py-10">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  >
                    <h4 className="font-semibold text-[#5E2B16] font-['Roboto_Flex'] text-[18px]">
                      {item.title}
                    </h4>
                    <p className="text-sm text-[#8B5E3C] font-['Roboto_Flex'] text-[16px] mt-1">
                      {item.desc}
                    </p>
                  </motion.div>
                ))}
                ...
                <div className="grid md:grid-cols-2 gap-5 text-[14px]">
                  ...
                  {[
                      ...
                      >
                        ...
                        <div>
                          <h4 className="font-semibold text-[#5E2B16]">
                            {item.title}
                          </h4>
                          <p className="text-sm text-[#8B5E3C] text-[14px] mt-1">
                            {item.desc}
                          </p>
                        </div>
                      </motion.div>
              ...
              <div className="mt-8 space-y-3">
                ...
                {[
                  ...
                  <div
                    key={i}
                    className="bg-[#D9DFC8] px-4 py-3 rounded-lg text-[#5E2B16] text-[14px] flex items-center gap-2"
                  >
        ...
        <div className="bg-[#EBF1DC] py-12 md:py-16 text-center">
          ...
          <div className="bg-[radial-gradient(circle,_#EBF1DC_60%,_#CCD7B2_100%)] py-6 md:py-10">
            ...
            >
              Toxin-free | Fragrance-free | Paraben-free <br className="sm:hidden" />
            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6">
              ...
              ">
                ...
                {[
                  ...
                  { icon: faSkullCrossbones, text: "Free from parabens, sulfates, and harsh additives" },
                  { icon: faHandHoldingHeart, text: "A portion of every purchase supports cancer patients" },
                  { icon: faGlobe, text: "Committed to people, society, and the planet" },
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 mb-12">
          ...
          >
            ...
            <div className="space-y-3 text-[#5E2B16] text-[16px]">
              ...
              <p><span className="text-[#5C6936] font-['Roboto_Flex'] text-[14] font-semibold">Skin Type:</span> All skin types, including sensitive, dry, oily, and combination skin</p>

              <p><span className="text-[#5C6936] font-['Roboto_Flex'] text-[14] font-semibold">Texture:</span> Smooth gel, gentle on skin</p>

              <p><span className="text-[#5C6936] font-['Roboto_Flex'] text-[14] font-semibold">Age:</span> Ideal for teenagers (15+) and adults</p>

              <p><span className="text-[#5C6936] font-['Roboto_Flex'] text-[14] font-semibold">Special Conditions:</span> Safe for use during pregnancy</p>

              <p><span className="text-[#5C6936] font-['Roboto_Flex'] text-[14] font-semibold">Gender:</span> Suitable for all gender</p>
          ...
          >
            ...
            <div className="space-y-4 text-[#5E2B16] text-[16px]">
              ...
              <div className="flex gap-3 items-start font-['Roboto_Flex'] text-[14px] text-[#5C6936] ">
                <FontAwesomeIcon icon={faClipboardCheck} className="mt-1 text-[#819744]" />
                <p>Always patch test before first use, especially if you have sensitive skin.</p>
              </div>

              <div className="flex gap-3 items-start font-['Roboto_Flex'] text-[14px] text-[#5C6936] ">
                <FontAwesomeIcon icon={faSnowflake} className="mt-1 text-[#819744]" />
                <p>Store in a cool, dry place away from direct sunlight.</p>
              </div>

              <div className="flex gap-3 items-start font-['Roboto_Flex'] text-[14px] text-[#5C6936] ">
                <FontAwesomeIcon icon={faLeaf} className="mt-1 text-[#819744]" />
                <p>Handle with care—natural ingredients may separate slightly, which is normal.</p>
              </div>
            ...
            <AnimatePresence>
              {activeIndex === i && (
                <motion.div
                  ...
                  className="px-6 pb-4 text-[#8B5E3C] text-[14px] leading-6"
                >
                  {item.a}
                </motion.div>
              )}
